           ...
           <div class="row">
             ...
             <div class="col-md-12">
               ...
               <div class="card card-primary">
                 ...
                 <!-- /.card-header -->
                 <!-- form start -->
                  {!!Form::open(['action' => ['App\Http\Controllers\AcademyController@editAcademy',$academy->id],'method'=>'POST','class'=>'form-horizontal',
                   ...
                   <div class="card-body">
                     <div class="form-group">
                      ...
                      {{Form::text('academy_name',$academy->academy_name,['placeholder'=>'أدخل إسم الأكاديمية','class'=>'form-control'])}}
