       ...
       <div class="row">
         ...
         <div class="col-md-12">
           ...
           <div class="card card-primary">
             ...
             <!-- /.card-header -->
             <!-- form start -->
             {!!Form::open(['action' => ['App\Http\Controllers\SchoolController@editSchool',$school->id],'method'=>'POST','class'=>'form-horizontal',
                 ...
                 <div class="form-group">
                      <div class="form-group">
                          <div class="row mb-3">
                            <div class="col">
                              ...
                              {{Form::text('school_name',$school->school_name,['placeholder'=>'إسم المؤسسة','class'=>'form-control'])}}
                            </div>
                            ...
                            <div class="col">
                              ...
                              <div class="form-check">
                                ...
                                {{Form::checkbox('school_qual',$school->school_qual,['placeholder'=>'إسم المؤسسة','class'=>'form-control'])}}
                              <!--/div>
                              <div class="form-check"-->
                                {{ Form::label('school_coll', 'إعدادية  :')}}
                                 {{Form::checkbox('school_coll',$school->school_coll,['placeholder'=>'إسم المؤسسة','class'=>'form-control'])}}
                              </div>
                            </div>
                        </div>                   
                    </div>
                    <!--div class="row">
                      <div class="col-md-4 form-group mb-2">
                        {{ Form::label('school_coll', 'إعدادية  :')}}
                        {{Form::checkbox('school_coll',$school->school_coll,$school->school_coll,['placeholder'=>'إسم المؤسسة','class'=>'form-control'])}}

                        {{ Form::label('school_qual', 'تأهيلية  :')}}
                        {{Form::checkbox('school_qual',$school->school_qual,$school->school_qual,['placeholder'=>'إسم المؤسسة','class'=>'form-control'])}}
                      </div>
                    </div-->
                    ...
                    <div class="row">
                      <div class="col-md-12 form-group mb-3">
                        ...
                        {{ Form::select('directorate_id', $directorates, $school->directorate_id, ['class' => 'form-control select2'])}}
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        {{ Form::select('district_id', $districts, $school->district_id, ['class' => 'form-control select2'])}}
                      </div>
                      <div class="form-group">         
                       {{Form::label('','عدد أقسام')}}
                       {{Form::number('school_classes',$school->school_classes,['placeholder'=>'عدد أقسام','class'=>'form-control'])}}
                     </div>
                      <div class="form-group">       
                       {{Form::label('','عدد المتعلمين')}}
                       {{Form::number('school_effectif',$school->school_effectif,['placeholder'=>'عدد المتعلمين','class'=>'form-control'])}}
                     </div>
