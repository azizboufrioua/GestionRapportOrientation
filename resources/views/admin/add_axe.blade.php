           ...
           <div class="row">
             ...
             <div class="col-md-12">
               ...
               <div class="card card-primary">
                 ...
                 <!-- /.card-header -->
                 <!-- form start -->
                  {!!Form::open(['action' => 'App\Http\Controllers\AxeController@saveAxe','method'=>'POST','class'=>'form-horizontal',
                   ...
                   <div class="card-body">
                     <div class="form-group">
                      ...
                      {{Form::text('axe_name','',['placeholder'=>' أدخل المجال أوالمحور ','class'=>'form-control'])}}
             ...
             <div class="card-body">
               <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tr>
                   ...
                   <td>
                    @if ($axe->status)
                    <a href="{{url('/activer_axe/'.$axe->id)}}" class="btn btn-success"><i class="nav-icon fa fa-power-off"></i></a>
                    @else
                    <a href="{{url('/activer_axe/'.$axe->id)}}" class="btn btn-danger"><i class="nav-icon fa fa-power-off"></i></a>
                    @endif
