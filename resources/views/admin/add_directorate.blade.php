       ...
       <div class="row">
         ...
         <div class="col-md-12">
           ...
           <div class="card card-primary">
             ...
             <!-- /.card-header -->
             <!-- form start -->
             {!!Form::open(['action' => 'App\Http\Controllers\DirectorateController@saveDirectorate','method'=>'POST','class'=>'form-horizontal',
            ...
            {{csrf_field()}}
               <div class="card-body">
                 <div class="form-group">
                   ...
                   {{Form::text('directorate_name','',['placeholder'=>'أدخل إسم مديرية','class'=>'form-control'])}}
                 
                  <div class="row">
                    <div class="col-md-12 form-group mb-3">
                      {{ Form::label('academy_id', 'تابعة للأكاديمية :')}}
                      {{ Form::select('academy_id', $academies, null, ['class' => 'form-control select2'])}}
                    </div>
                  </div>
              </div>
